  ...
  return mockInterViewQuestion&&(
    <div className='p-5 border rounded-lg my-10'>
        ...
        <h2 className='my-5 text-sm md:text-lg'>
          <strong>Q.</strong>  {mockInterViewQuestion?.interviewQuestions[activeQuestionIndex]?.question}
        </h2>
        <Volume2 className='cursor-pointer' onClick={()=>textToSpeach(mockInterViewQuestion?.interviewQuestions[activeQuestionIndex]?.question)} />
